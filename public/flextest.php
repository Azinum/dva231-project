...
<body>
                                ...
                                <div class="result">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="itemWL"> W: 9999 | T: 9999 | L: 9999 </div>
                                            </td>
                                            <td>
                                                <div class="itemWLMobile"> W/T/L<br>9999/9999/9999</div>
                                            </td>
                                            <td>
                                                <div class="itemELO"> E: 400 </div>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
    ...
    <div class="flex-Con">
        <div id="item1"><a class="placement"> 9000. </a></div>
        <div id="item2"><img class="teamimg" src="/img/teamico.png"></div>
        <div id="item3"><a class="linktext" href="http://www.google.com">2nrdXuWOMHcFqMYzVDAFmZeQWeagZYugEuEA8cPN1G19q4TTXq</a></div>
        <div id="item4">W: 9999 | T: 9999 | L: 9999</div>
        <div id="item5">E: 400</div>
    </div>
